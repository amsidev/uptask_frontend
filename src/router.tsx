...
import CreatProjectView from './views/projects/CreatProjectView'
...
import NotFounc from './views/404/NotFound'
        ...
        <BrowserRouter>
            <Routes>
                <Route element={<AppLayout/>}>
                    ...
                    <Route path='/projects/create' element={<CreatProjectView/>} index />
